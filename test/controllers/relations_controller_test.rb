...
class RelationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post relations_url, params: { relation: { formulation_id: @relation.formulation_id, ingredient_id: @relation.ingredient_id, value: @relation.value } }
    end
  ...
  test "should update relation" do
    patch relation_url(@relation), params: { relation: { formulation_id: @relation.formulation_id, ingredient_id: @relation.ingredient_id, value: @relation.value } }
